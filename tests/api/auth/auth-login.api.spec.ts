...
test.describe('API Testing - OrangeHRM Real Authentication', () => {
    ...
    // ========================================================================
    // GROUP A: POSITIVE SCENARIOS
    // ========================================================================
    test.describe("Positive Scenarios", () => {
        test.beforeEach(async () => {
            await allure.subSuite("Positive Authentication");
    ...
    // ========================================================================
    // GROUP B: NEGATIVE SCENARIOS
    // ========================================================================
    test.describe("Negative Scenarios", () => {
        test.beforeEach(async () => {
            await allure.subSuite("Negative Authentication");
            await allure.feature("Authentication Validation");
        });
    ...
    // ========================================================================
    // GROUP C: SECURITY SCENARIOS
    // ========================================================================
    test.describe("Security Guardrails", () => {
        test.beforeEach(async () => {
            await allure.subSuite("Security Validation");
            await allure.feature("Payload Injection & Defenses");
        });
