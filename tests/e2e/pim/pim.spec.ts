...
test.describe("UI E2E Testing - PIM Module: Employee List", () => {

    // ========================================================================
    // CẤU HÌNH TOÀN CỤC (GLOBAL)
    // LƯU Ý: Nhãn 'package' tự động đã được cấu hình trong pim.fixture.ts
    // ========================================================================
    ...
    test.describe("PIM Module - UI Structure & Data Population @UIGroup", () => {
        ...
        test.beforeEach(async ({ page }) => {
            // Cấp 3: Nhóm UI Structure
            await allure.subSuite("UI Structure & Data Population");
    ...
    test.describe("PIM Module - Filters & Data Sorting @FilterSortGroup", () => {
         ...
         */
        test.beforeEach(async ({ page }) => {
            // Cấp 3: Nhóm Filters & Data Sorting
            await allure.subSuite("Filters & Data Sorting");
            await allure.feature("Employee List functionality");
            test.setTimeout(60000);
        });
    ...
    test.describe("PIM Module - Advanced Search Functionality @SearchGroup", () => {
         ...
         */
        test.beforeEach(async ({ page }) => {
            // Cấp 3: Nhóm Advanced Search Functionality
            await allure.subSuite("Advanced Search Functionality");
            await allure.feature("Employee List functionality");
            test.setTimeout(60000);
        });
    ...
    test.describe("PIM Module - Table Interactions & Actions @ActionGroup", () => {
         ...
         */
        test.beforeEach(async ({ page }) => {
            // Cấp 3: Nhóm Table Interactions & Actions
            await allure.subSuite("Table Interactions & Actions");
            await allure.feature("Employee List functionality");
            test.setTimeout(60000);
        });
    ...
    test.describe("PIM Module - Pagination & State Resilience @StateGroup", () => {
         ...
         */
        test.beforeEach(async ({ page }) => {
            // Cấp 3: Nhóm Pagination & State Resilience
            await allure.subSuite("Pagination & State Resilience");
            await allure.feature("Employee List functionality");
            test.setTimeout(60000);
        });
