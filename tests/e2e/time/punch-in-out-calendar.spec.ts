...
test.describe("UI E2E Testing - Time Module: Calendar Widget", () => {
    ...
    test.beforeEach(async ({ page }) => {
        // Dịch cấp: Cấp 1 là UI E2E, Cấp 2 là Time Module
    ...
    // ========================================================================
    // GROUP A: UI VISIBILITY & BASIC INTERACTION
    // ========================================================================
    test.describe("UI Visibility & Basic Interaction", () => {
        test.beforeEach(async () => {
            // Cấp 3: Nhóm Tương tác cơ bản
            await allure.subSuite("UI Visibility & Basic Interaction");
    ...
    // ========================================================================
    // GROUP B: ADVANCED NAVIGATION & SELECTION
    // ========================================================================
    test.describe("Advanced Navigation & Selection", () => {
        test.beforeEach(async () => {
            // Cấp 3: Nhóm Điều hướng nâng cao
            await allure.subSuite("Advanced Navigation & Selection");
            await allure.feature("Attendance Calendar");
        });
    ...
    // ========================================================================
    // GROUP C: INPUT VALIDATION & BEHAVIOR
    // ========================================================================
    test.describe("Input Validation & Behavior", () => {
        test.beforeEach(async () => {
            // Cấp 3: Nhóm Xử lý dữ liệu nhập
            await allure.subSuite("Input Validation & Behavior");
            await allure.feature("Attendance Calendar");
        });
